...
void plotMuonIDData() {
    ...
    const int nids  =  9;
    char *ids[nids]    = { "PF",    "SIP4_from_PF", "PFIso40_from_PF_and_SIP4", "HLT_Mu17_from_PF_and_SIP4_and_PFIso40", "HLT_Mu8_from_PF_and_SIP4_and_PFIso40", "HLT_OrMu17_from_PF_and_SIP4_and_PFIso40", "HLT_OrMu8_from_PF_and_SIP4_and_PFIso40", "HLT_TkMu17_from_PF_and_SIP4_and_PFIso40", "HLT_TkMu8_from_PF_and_SIP4_and_PFIso40" };
    char *titles[nids] = { "PF ID", "SIP < 4",      "PF Iso < 0.4" ,            "Mu17",     "Mu8", "Mu17 OR",     "Mu8 OR", "Mu17 Tk", "Mu8 Tk" };
