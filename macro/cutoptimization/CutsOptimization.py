...
DEFAULT_INFNAMESIG  = "../results_data/merged.root"
DEFAULT_INFNAMEBKG  = "../results_data_fakes/merged.root"
DEFAULT_FRIENDNAMESIG  = "../results_data/merged_hzzisoFriend.root"
DEFAULT_FRIENDNAMEBKG  = "../results_data_fakes/merged_hzzisoFriend.root"
DEFAULT_TREESIG  = "eleIDdir/T1"
DEFAULT_TREEBKG  = "eleIDdir/T1"
...
def usage():
    ...
    print "  -a | --addedcuts : additional cuts to the preselection"
    print "  -v | --verbose"
    print "  -g | --gui : run the GUI at the end of the process (default is False)"
